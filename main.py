...
async def main() -> None:
    ...
    # Manually start the application parts to avoid event loop conflicts
    await app.initialize()
    await app.start()
    await app.updater.start_polling()
    await app.updater.idle() # This keeps the bot running until stopped externally
...
if __name__ == "__main__":
    try:
        ...
        # Schedule the main coroutine and run the loop forever
